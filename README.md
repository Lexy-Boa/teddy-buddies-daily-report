# Teddy Buddies — Daily Social Pulse
...
- **The 10-second version** — a plain-language verdict of the day, written the way an analyst would brief a founder
- **Board view** — KPI tiles: net followers, views, enquiries (30d), cost per enquiry, cost per admission, new reviews
- **Admissions funnel** — reach → clicks → enquiries → campus visits → admissions, with stage-by-stage conversion and cost
- **Detailed view** — per-platform breakdowns (Instagram, Facebook, Google Reviews), per-creative ad performance with scale/hold/cut calls

## Design decisions

- **Single self-contained HTML file, zero dependencies** — opens anywhere, loads instantly, trivially embeddable in a daily email or WhatsApp link
